...
<style>
body { font-family: system-ui, sans-serif; background: #0d1117; color: #c9d1d9; max-width: 800px; margin: 40px auto; padding: 20px; }
...
<p>Most frequent code identifiers (class/variable names). Color-coded by source language.</p>
<pre>?username=octocat
&amp;extract=classes,variables</pre>
</div>

<h3>Example</h3>
<pre>&lt;img src="https://your-domain.vercel.app/api/language_stats?username=octocat" /&gt;</pre>
